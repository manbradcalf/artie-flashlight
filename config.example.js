...
exports.FB_SERVICEACCOUNT = process.env.FB_ACC || 'heroku-bookyrself-staging-firebase-adminsdk-leedp-cd1a228863.json';
...
exports.paths = [
  ...
  },
  {
    ...
    index : "events",
    type  : "event",
    fields: ['tags', 'eventname', 'citystate', 'description', 'host']
    // fields: ['msg', 'name'],
